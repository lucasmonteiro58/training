    ...
    >
      <div className="card p-5 border border-accent/20 bg-surface/80 backdrop-blur-xl shadow-2xl animate-fade-up">
        ...
        <div className="flex gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-accent to-accent-hover flex items-center justify-center shadow-lg shadow-accent/20 flex-shrink-0">

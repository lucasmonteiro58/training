...
export function ConfiguracoesCard({
  ...
  return (
    <div className="card p-1 mb-5 animate-fade-up" style={{ animationDelay: '100ms' }}>
      <p className="text-xs font-bold text-[var(--color-text-muted)] px-4 py-3 uppercase tracking-wider">
        Conta e Recursos
      </p>
      ...
      >
        <div
          className={`w-9 h-9 rounded-xl flex items-center justify-center ${
            notifPermitida ? 'bg-[rgba(245,158,11,0.12)]' : 'bg-[var(--color-surface-2)]'
          }`}
        >
          {notifPermitida ? (
